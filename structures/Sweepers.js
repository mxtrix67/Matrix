...
const memoryLogger = new WebhookClient({
    url: 'https://discord.com/api/webhooks/1352475734958145597/TLdHnrzQvjV_fqwJJGNni6w9MPszAAo5hdluJioF9xmCBR85b4E90PblSR5P1aYnVRBP'
})
...
module.exports = class MemorySweeper {
    ...
    run() {
        ...
        for (const guild of this.client.guilds.cache.values()) {
            ...
            // Clear emojis
            if (guild.id !== '1220032592997519491') {
        ...
        if (this.client.user.tag !== 'Matrix#7940') return
