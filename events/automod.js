...
module.exports = async (client) => {
    client.on('messageCreate', async (message) => {
        let check = message.guild ? await client.util.BlacklistCheck(message.guild) : false;
                ...
                try {
                    ...
                    if (action === 'ban') {
                        ...
                        if (message.member.bannable) {
                            try {
                                let reason = 'Matrix | ANTILINK | BAN'
