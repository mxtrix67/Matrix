...
module.exports = async (client) => {
    client.on('guildCreate', async (guild) => {
        try {
            ...
            let channel
            try {
                channel = await client.channels.fetch(join)
            } catch (error) {
                console.error(`Failed to fetch join log channel ${join}:`, error.message || error)
                return
            }
            ...
            console.error('Error handling guildCreate in guildlogs.js:', error)
        }
    })
    ...
    client.on('guildDelete', async (guild) => {
        try {
            ...
            let channel
            try {
                channel = await client.channels.fetch(leave)
            } catch (error) {
                console.error(`Failed to fetch leave log channel ${leave}:`, error.message || error)
                return
            }
            ...
            console.error('Error handling guildDelete in guildlogs.js:', error)
        }
    })
}
